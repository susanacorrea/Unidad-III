...
class Composite(Component): #Inherits from the abtract class, Component
    """Concrete class and maintains the tree recursive structure"""

    def __init__(self, *args, **kwargs):
        Component.__init__(self, *args, **kwargs)

        #This is where we stire the name of the composite object
        self.name = args[0]
    ...
    def component_function(self):
        ...
        #Iterate throught the child objects and invoke their component fucntion printing their names
